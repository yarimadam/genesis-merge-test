...
namespace CoreSvc.Filters
{
    public static class CookieServiceCollectionExtensions
    {
        ...
        /// <seealso cref="Microsoft.AspNetCore.Http.SameSiteMode" /> enum will have a definition for
        /// Unspecified.
        /// </summary>
        ...
        private static void CheckSameSite(HttpContext httpContext, CookieOptions options)
        {
            if (options.SameSite == SameSiteMode.None)
            {
                ...
                // https://github.com/dotnet/aspnetcore/issues/19939#issuecomment-600614330
